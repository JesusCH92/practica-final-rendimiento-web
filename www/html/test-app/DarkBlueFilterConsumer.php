...
$callback = function ($msg) use ($addFilterImagesService){
    try{
        ...
        $filterImageCreate = $addFilterImagesService->__invoke($imagePath, $imageOriginalName, $imageActualName, $imageRenameForFilterImage, $imageExtension, 'addDarkBlueFilter');
