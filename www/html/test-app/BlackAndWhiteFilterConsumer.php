...
echo 'Add black and white filter to images ' . PHP_EOL;
...
$callback = function ($msg) use ($addFilterImagesService){
    try{
        ...
        $filterImageCreate = $addFilterImagesService->__invoke($imagePath, $imageOriginalName, $imageActualName, $imageRenameForFilterImage, $imageExtension, 'addBlackAndWhiteFilter');
